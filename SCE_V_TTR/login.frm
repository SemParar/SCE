...
On Error GoTo LoadError
    ...
    If Not DbOpen(gsPath_DS, gsPath_DB) Then
          MsgBox "DataBase Parking não pode ser aberto! Aplicação será finalizada!", vbCritical, "Erro"
          End
    End If
...
If txtNome_Usuario.Text = "" Then
   MsgBox "Informe o nome do usuário !", vbCritical, "Logon"
...
If rsUsuario.RecordCount <> 0 Then
  ...
  Else
     MsgBox "Senha inválida, tente novamente !", vbCritical, "Logon"
     txtSenha.SetFocus
     txtSenha.SelStart = 0
  ...
  End If
  Else
     MsgBox "Usuário não cadastrado !", vbCritical, "Logon"
     txtNome_Usuario.SetFocus
